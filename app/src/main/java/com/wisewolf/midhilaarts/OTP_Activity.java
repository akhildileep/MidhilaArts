...
public class OTP_Activity extends AppCompatActivity {
    ...
    String mVerificationId,countryCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(OTP_Activity.this, "Resent", Toast.LENGTH_SHORT).show();
                sendOtp();
            }
        });
                        ...
                        .addOnCompleteListener(OTP_Activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(OTP_Activity.this, "Verification Success", Toast.LENGTH_SHORT).show();

                                    addDB(GlobalData.user);

                                } else {
                                    if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                        Toast.makeText(OTP_Activity.this, "Verification Failed, Invalid credentials", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        });
    ...
    private void builBuilder() {
        builder  = new  AlertDialog.Builder(OTP_Activity.this);
    ...
    private void sendOtp() {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
            countryCode+ GlobalData.user.getMobile_no(),        // Phone number to verify
            1,                 // Timeout duration
    ...
    private void init() {
        ...
        countryCode=intent.getStringExtra("cc");
